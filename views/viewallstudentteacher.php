 ...
 <!-- Dashboard begins -->
    ...
    <div class="block lg:flex  ">
        ...
        <div class=" md:w-[78vw] mt-[10px] md:h-[630px] h-[400px] rounded-br-lg rounded-bl-lg bg-white md:shadow-2xl pt-10 md:pl-8 md:px-0 px-4" id="mainpage">
            <div class="">
                <div class="">
                    <h1 class="md:text-4xl text-2xl font-[700] md:text-center mb-6">All Students</h1><br>
                    ...
                    <div class="max-h-[450px] overflow-auto ">
                        <table class=" border-collapse  mx-[auto] text-[17px] ">
                            ...
                            <th class="border md:pr-20 pr-2 " style="border-left: none; border-right: none;" >Id</th>
                                <th class="border md:pr-20 pr-2 " style="border-left: none; border-right: none;" >RollNum</th>
                                ...
                                <th class="border md:pr-20 pr-2 py-2"style="border-left: none; border-right: none;">Age</th>
                                <th class="border md:pr-20" style="border-left: none; border-right: none;">Class</th>
                                <th class="  border py-2 pr-20"style="border-left: none; border-right: none;">Home Address</th>
                                <th class="  border py-2 pr-20"style="border-left: none; border-right: none;">Image</th>
                            </tr>

                            <?php
                                   include "../controllers/connection.php";
                                   $query= "SELECT * FROM teacheraddstudent";
